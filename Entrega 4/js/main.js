...
const hero = [
  {
    ...
    elementos: [                                                        // velocidad   punto de partida antes de ser visibles
      { elem: document.getElementById("arbusto-corto-izquierda"),       factor: 0.175, inicioFuera: 50 },
      { elem: document.getElementById("roca-izquierda"),                factor: 0.15,  inicioFuera: 70 },
      { elem: document.getElementById("arbol-izquierda"),               factor: 0.115, inicioFuera: 60 },
      { elem: document.getElementById("arbusto-largo-izquierda"),       factor: 0.1,  inicioFuera: 65 },
      { elem: document.getElementById("roca-grande-derecha"),           factor: 0.12,  inicioFuera: 75 },
      { elem: document.getElementById("roca-chica-derecha-1"),          factor: 0.15,  inicioFuera: 70 },
      { elem: document.getElementById("roca-chica-derecha-2"),          factor: 0.1,  inicioFuera: 75 },
      { elem: document.getElementById("arbol-derecha-delante"),         factor: 0.14, inicioFuera: 80 },
      { elem: document.getElementById("arbusto-largo-derecha-delante"), factor: 0.125,  inicioFuera: 70 },
      { elem: document.getElementById("arbol-derecha-detras"),          factor: 0.175,  inicioFuera: 55 },
      { elem: document.getElementById("arbusto-largo-derecha-detras"),  factor: 0.124, inicioFuera: 25 },
      { elem: document.getElementById("ff-2"),                          factor: 0.05,  inicioFuera: 75},
      { elem: document.getElementById("ff-3"),                          factor: 0.265, inicioFuera: 75 },
      { elem: document.getElementById("ff-1"),                          factor: 0.17, inicioFuera: 75 },
    ],
  },
];
